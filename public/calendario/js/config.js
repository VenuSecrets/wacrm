/* ============================================================
   ...
   ============================================================ */
// Proyecto Supabase unificado de WACRM (CRM + Calendario + Fotos comparten
// esta misma base de datos). Antes apuntaba al proyecto "One Trier"; ahora
// todo el software del centro vive en el proyecto del CRM.
const SUPABASE_URL = "https://oxjlbtfyuzfpiybzxpkd.supabase.co";        // proyecto WACRM
